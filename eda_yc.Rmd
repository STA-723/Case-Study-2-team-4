...
- `availability` cannot be used as a measurement for popularity; what does it mean? -> use # of reviews
- delete the one price==0
...
dat%>%group_by(neighbourhood_group,neighbourhood)%>%summarise(count=n())%>%arrange(desc(count))
```
