...
Figures \ref{fig:mapprice,fig:mappop,fig:maptraffic} suggest a clear spatial structure for price, popularity and traffic. Most high-priced listings are located in midtown and downtown Manhattan, while some of them also lie in the part in Brooklyn that is closed to. Similar pattern is discovered for traffic. Most popular neighborhood locates around LGA airport. Figure \ref{fig:roomtype4} shows a significant heterogeneity across neighborhoods and boroughs. In addition, Figures \ref{fig:roomtype1,fig:roomtype2} demonstrate that the room type matters for price but not for popularity. We can also see the heterogeneity of room type across boroughs/neighborhoods as shown in Figure. A Pearson's Chi-squared test (p-value < 2.2e-16) is conducted to further support the conclusion. Figure \ref{fig:night,fig:night1} suggest a non-linear effect on price/popularity. 
